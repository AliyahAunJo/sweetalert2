(function() {
    ...
    function darkOverlay() {
        ...
        overlay.style.cssText = 'position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.95); z-index: 10000; display: flex; justify-content: center; align-items: center; color: white; font-size: 24px; text-align: center; flex-direction: column;';
    ...
    var observer = new MutationObserver(function(mutations) {
        if (!document.body.contains(banner) || !banner.textContent.includes('©️ครูอั๋น ใจดี')) {
